...
class Patient extends Model
{
    protected $fillable = [
        ...
        'cholesterol',
        'clinical_findings',
        'clinical_findings_other',
        'pes_problem',
        'pes_etiology',
        'pes_signs_symptoms',
        'nutrition_diagnosis_priority_1',
        'nutrition_diagnosis_priority_2',
        'nutrition_diagnosis_priority_3',
    ...
    protected $casts = [
        ...
        'hb'              => 'decimal:1',
        'albumin'         => 'decimal:1',
        'creatinine'      => 'decimal:1',
        'urea'            => 'decimal:1',
        'sodium_na'       => 'decimal:1',
        'potassium_k'     => 'decimal:1',
        'cholesterol'     => 'decimal:1',
        'clinical_findings'         => 'array',
        'nutrition_impact_symptoms' => 'array',
        'nutrition_prescription'    => 'array',
    ];
